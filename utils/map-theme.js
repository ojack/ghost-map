...
var ColorManipulator = require('./color-manipulator');

var CustomTheme = {
  spacing: Spacing,
  contentFontFamily: 'Anonymous Pro, monospace',
  getPalette: function() {
    return {
    ...
    /*  primary2Color: Colors.cyan700,
      ...
      accent1Color: Colors.fullWhite,
      accent2Color: Colors.fullWhite,
      accent3Color: Colors.fullWhite,
  ...
  getComponentThemes: function(palette) {
    var obj = {
      ...
      flatButton: {
        ...
        secondaryTextColor: palette.secondary1Color,
      },
      ...
      menuItem: {
        dataHeight: 32,
        height: 48,
        hoverColor: 'rgba(255, 255, 255, .035)',
      ...
      raisedButton: {
        ...
        primaryTextColor: palette.canvasColor,
        secondaryColor: palette.primary1Color,
      ...
      toolbar: {
        ...
        menuHoverColor: 'rgba(255, 255, 0, .10)'
      },
      tabs: {
